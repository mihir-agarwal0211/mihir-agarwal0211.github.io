...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        description: "Common questions about getting into Columbia University&#39;s graduate programs — answered from my own experience.",
        section: "Posts",
        handler: () => {
        ...
        handler: () => {
            ...
            window.location.href = "/assets/pdf/Mihir_Agarwal.pdf";
